...
Deno.test('assignTopic - successful classification with SEO content and array', async () => {
	const taxonomy = [
		{
			topic: 'Technology',
			subtopics: ['Artificial Intelligence', 'Cloud Computing', 'Cybersecurity']
...
Deno.test('assignTopic - classifies business strategy text', async () => {
	const taxonomy: TaxonomyType = {
		topics: [
			{
				topic: 'Business',
...
Deno.test('assignTopic - classifies marketing content', async () => {
	const taxonomy: TaxonomyType = {
		topics: [
			{
				topic: 'Marketing',
...
Deno.test('extractTopics - extracts topics from product records', async () => {
	const records = [
